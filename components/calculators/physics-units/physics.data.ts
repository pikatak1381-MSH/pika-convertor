...
export const physicsUnitTypes: CalculatorDefinition[] = [
  /* Angular Acceleration */
  {
    ...
    units: [
      ...
      {
        id: "deg-per-s2",
        labelKey: "physics.angularAcceleration.units.degPerS2",
        factor: Math.PI / 180,
      },
      {
        id: "rev-per-s2",
        labelKey: "physics.angularAcceleration.units.revPerS2",
        factor: 2 * Math.PI,
      },
      {
        id: "rev-per-min2",
        labelKey: "physics.angularAcceleration.units.revPerMin2",
        factor: (2 * Math.PI) / 3600,
      },
      {
        id: "rpm-per-s",
        labelKey: "physics.angularAcceleration.units.rpmPerS",
        factor: (2 * Math.PI) / 60,
      },
      {
        id: "rpm-per-min",
        labelKey: "physics.angularAcceleration.units.rpmPerMin",
        factor: (2 * Math.PI) / 3600,
      },
    ],
  },
  ...
  /* Temperature */
  {
    ...
    units: [
      ...
      {
        id: "fahrenheit",
        labelKey: "physics.temperature.units.fahrenheit",
        factor: 5 / 9,
        offset: 459.67,
      },
    ],
