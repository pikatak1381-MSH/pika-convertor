  ...
  return (
    <div className="mt-4 flex flex-col">
      ...
      <FloatingLabelInput
        type="number"
        value={value}
        label={t("engineering.fluids.placeholder")}
      ...
      <div className="mt-2 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        <div className="col-span-2 flex items-center gap-1">
          ...
          <Select dir={dir} value={fromUnit} onValueChange={setFromUnit}>
            <SelectTrigger className="bg-background border-input text-secondary-foreground w-full min-w-0 flex-1 truncate rounded-[20px] border px-3 text-sm font-bold">
              <SelectValue />
            </SelectTrigger>
            <SelectContent className="bg-background text-secondary-foreground rounded-2xl text-sm font-semibold">
